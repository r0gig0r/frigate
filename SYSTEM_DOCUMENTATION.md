...
```bash
cd /home/rogigor/frigate-custom
git status
```
...
#### `/home/rogigor/frigate-custom/frigate/config/camera/ffmpeg.py`
...
#### `/home/rogigor/frigate-custom/frigate/ffmpeg_presets.py`
...
#### `/home/rogigor/frigate-custom/frigate/video.py`
...
- Located in: `/home/rogigor/frigate-custom/web/src/components/overlay/detail/`
...
**File:** `/home/rogigor/frigate/docker-compose.yml`
...
Type=simple
User=rogigor
WorkingDirectory=/home/rogigor/battery-cam-processor
ExecStart=/usr/bin/python3 -u /home/rogigor/battery-cam-processor/process-battery-cam.py
...
**Location:** `/home/rogigor/battery-cam-processor/process-battery-cam.py`
...
- Symlink-based file handoff to Frigate (`/home/rogigor/frigate/media/battery-cam/current.mp4`)
...
**File:** `/home/rogigor/battery-cam-processor/processed.db`
...
sqlite3 /home/rogigor/battery-cam-processor/processed.db \
...
PROCESSING_DIR = "/home/rogigor/frigate/media/battery-cam"
CURRENT_VIDEO_LINK = f"{PROCESSING_DIR}/current.mp4"
DB_PATH = "/home/rogigor/battery-cam-processor/processed.db"
...
**File:** `/home/rogigor/frigate/config/config.yml`
...
|---------------|-----------|---------|--------|
| `/config` | `/home/rogigor/frigate/config` | Frigate configuration | RW |
| `/media/frigate` | `/home/rogigor/frigate/media` | Recordings, snapshots, clips | RW |
...
**Symlink:** `/home/rogigor/frigate/media/battery-cam/current.mp4`
...
```bash
# Vacuum database
sqlite3 /home/rogigor/battery-cam-processor/processed.db "VACUUM;"

# Check size
ls -lh /home/rogigor/battery-cam-processor/processed.db
```
...
cp /home/rogigor/battery-cam-processor/processed.db \
   /home/rogigor/battery-cam-processor/processed.db.backup
```
...
- Symlink broken: Check `/home/rogigor/frigate/media/battery-cam/current.mp4`
- Zero-byte files: Service auto-skips files >30s old with 0 bytes

**Manual processing test:**
```bash
cd /home/rogigor/battery-cam-processor
...
# Check symlink
ls -la /home/rogigor/frigate/media/battery-cam/current.mp4

# Check target file exists
readlink /home/rogigor/frigate/media/battery-cam/current.mp4
```
...
- **Face Recognition Integration:** `/home/rogigor/frigate-custom/docs/face_improvements/FACE_RECOGNITION_INTEGRATION.md`
- **Battery Processor Setup:** `/home/rogigor/battery-cam-processor/SETUP.md`
